# Legacy Progress Tests — historical reference

This describes behavior before the immutable tutor-workspace launch. After cutover, legacy mutations and notifications are retired. See [current workflow](progress-tests.md).
