...
1. Deploy code and run the `0040_student_promotions.sql`, `0046_student_promotion_future_sessions.sql`, and `0047_student_promotion_graduation_pay_rates.sql` migrations.
