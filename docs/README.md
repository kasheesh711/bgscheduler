...
| [Student Schedule](./features/student-schedule.md) | stable | One student's month of classes: admin lookup and print-to-PDF, plus a no-login token link a parent opens from LINE. Same payload, same calendar component, three surfaces. |
