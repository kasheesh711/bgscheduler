...
| [Leave Requests](./features/leave-requests.md) | stable | Daily roster-owned teacher/date assignments with family notification and manual Wise cancellation checklists; automatically interprets source submissions with Astra medium. |
