...
| GET | `/api/tutor-sit-ins/calendar/microsoft/callback` | Microsoft-specific session/state/PKCE callback. Same safe redirect and cookie cleanup as Google. |
