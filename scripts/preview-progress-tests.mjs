...
await pool.query("TRUNCATE pt_workspace_config, pt_series, pt_papers, pt_files, pt_jobs, tutor_contacts, admin_users RESTART IDENTITY CASCADE");
...
const students = [{name:"Sample Maya",course:"Year 8 · Mathematics",count:6},{name:"Sample Nathan",course:"Year 10 · Physics",count:7},{name:"Sample Aria",course:"Year 9 · Chemistry",count:9},{name:"Sample Ethan",course:"Year 7 · Mathematics",count:4},{name:"Other tutor’s student",course:"Group · Biology",count:8,owner:"b"}];
...
server.listen(3335,"127.0.0.1",()=>console.log("Local fixture sign-in: http://localhost:3335/teacher (or /admin, /other-tutor)"));
