...
**Shipped version:** v1.0 (2026-04-17) + v1.0.1 hotfeature (2026-04-20, commit `9e3e4ad`) + v1.1 Phase 5 POLISH Drain (2026-04-21, commit `303dcf6`)
**Production URL:** https://bgscheduler.vercel.app
**Status:** Live, daily Wise sync active, 669 tests passing across 97 test files
...
v1.1 scope remaining after Phase 5 POLISH Drain:

- **MOD-01..05** Reliable online/onsite detection — `isOnlineVariant` + sessionType primary signals with `modalityConfidence` grading; fail-closed test matrix in `compare.test.ts` — **Phase 6**
- **PAST-01..06** Past-day session visibility — orchestrator diff-hook into `past_session_blocks` table; dedicated `cacheTag('past-sessions')`; Wise historical endpoint spike — **Phase 7**
- **STICKY-01..04** Sticky tutor legend (VPOL-02) — pure-CSS `position: sticky`, documented z-index scale, stacking-context audit — **Phase 8**
...
---
*Last updated: 2026-04-21 — Phase 5 POLISH Drain complete (16/16 POLISH requirements closed); ready for Phase 6 MOD-01 Reliable Modality Detection*
