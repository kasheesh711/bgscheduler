...
export const unearnedRevenuePeriods = pgTable("unearned_revenue_periods", {
  ...
  compositeVerifiedCount: integer("composite_verified_count").notNull().default(0),
  receiptCandidateCount: integer("receipt_candidate_count").notNull().default(0),
  reversalConflictCount: integer("reversal_conflict_count").notNull().default(0),
  missingReceiptEvidenceCount: integer("missing_receipt_evidence_count").notNull().default(0),
...
export const unearnedRevenueLotPeriods = pgTable("unearned_revenue_lot_periods", {
  ...
  matchConfidence: text("match_confidence").notNull().default("RESIDUAL"),
  matchRuleId: text("match_rule_id").notNull().default(""),
  matchEvidence: jsonb("match_evidence").$type<Record<string, unknown>>().notNull().default({}),
  reviewState: text("review_state").notNull(),
  packageName: text("package_name").notNull(),
  ...
  candidateReceiptIds: text("candidate_receipt_ids").notNull().default(""),
  ...
  creditEventSpreadsheetId: text("credit_event_spreadsheet_id"),
  creditEventSheetId: integer("credit_event_sheet_id"),
  creditEventRow: integer("credit_event_row"),
  creditEventA1: text("credit_event_a1"),
  receiptSpreadsheetId: text("receipt_spreadsheet_id"),
  receiptSheetId: integer("receipt_sheet_id"),
  receiptRow: integer("receipt_row"),
  receiptA1: text("receipt_a1"),
  receiptId: text("receipt_id").notNull().default(""),
  receiptType: text("receipt_type").notNull().default(""),
  receiptStatus: text("receipt_status").notNull().default(""),
  receiptChargedAt: timestamp("receipt_charged_at", { withTimezone: true }),
  receiptAmountThb: numeric("receipt_amount_thb", { precision: 20, scale: 8 }).notNull().default("0"),
  receiptCurrency: text("receipt_currency").notNull().default(""),
  receiptNote: text("receipt_note").notNull().default(""),
  receiptStudentId: text("receipt_student_id").notNull().default(""),
  receiptClassId: text("receipt_class_id").notNull().default(""),
}, (table) => [
...
export const tutorSitInObservations = pgTable(
  "tutor_sit_in_observations",
  {
    ...
    calendarProvider: text("calendar_provider").$type<"google" | "microsoft">(),
    calendarAccountId: text("calendar_account_id"),
    eventId: text("event_id"),
    calendarSyncedAt: timestamp("calendar_synced_at", { withTimezone: true }),
    calendarAttemptedAt: timestamp("calendar_attempted_at", { withTimezone: true }),
