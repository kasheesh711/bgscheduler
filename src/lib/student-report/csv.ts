...
export const CLASSES_CSV_COLUMNS: CsvColumn<ClassesCsvRow>[] = [
  ...
  { key: "hasFeedback", header: "Feedback", value: (row) => row.feedback ? "yes" : "no" },
  { key: "feedbackTopics", header: "Topics", value: (row) => row.feedback?.topics ?? "" },
  { key: "feedbackPerformance", header: "Performance", value: (row) => row.feedback?.performance ?? "" },
  { key: "feedbackImprovement", header: "Needs work", value: (row) => row.feedback?.improvement ?? "" },
  { key: "feedbackHomework", header: "Homework", value: (row) => row.feedback?.homework ?? "" },
